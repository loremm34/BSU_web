...
public class ControllerMappings {
    ...
    static {
        ...
        controllersByURL.put("/cookies", new CookieController());
        controllersByURL.put("/doctors/list", new DoctorController());
        controllersByURL.put("/appointments/list", new AppointmentController());
        controllersByURL.put("/doctors/add", new DoctorAddController());
